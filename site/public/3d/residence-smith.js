...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Kn,depthTest:!1,depthWrite:!1})}function qc(){return new kn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:No(),fragmentShader:`
		...
		`,blending:Kn,depthTest:!1,depthWrite:!1})}function Yc(){return new kn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:No(),fragmentShader:`
...
`)}function Pm(i,e){let t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){let r=i.getActiveAttrib(e,s),o=r.name,a=1;r.type===i.FLOAT_MAT2&&(a=2),r.type===i.FLOAT_MAT3&&(a=3),r.type===i.FLOAT_MAT4&&(a=4),t[o]={type:r.type,location:i.getAttribLocation(e,o),locationSize:a}}return t}function Yi(i){return i!==""}function nl(i,e){let t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function il(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}var Lm=/^[ \t]*#include +<([\w\d./]+)>/gm;function oo(i){return i.replace(Lm,Nm)}var Im=new Map([["encodings_fragment","colorspace_fragment"],["encodings_pars_fragment","colorspace_pars_fragment"],["output_fragment","opaque_fragment"]]);function Nm(i,e){let t=st[e];if(t===void 0){let n=Im.get(e);if(n!==void 0)t=st[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return oo(t)}var Dm=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function sl(i){return i.replace(Dm,Um)}function Um(i,e,t,n){let s="";for(let r=parseInt(e);r<parseInt(t);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function rl(i){let e="precision "+i.precision+` float;
precision `+i.precision+" int;";return i.precision==="highp"?e+=`
#define HIGH_PRECISION`:i.precision==="mediump"?e+=`
#define MEDIUM_PRECISION`:i.precision==="lowp"&&(e+=`
#define LOW_PRECISION`),e}function Om(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===El?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===Ro?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===Dn&&(e="SHADOWMAP_TYPE_VSM"),e}function Fm(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case $i:case ji:e="ENVMAP_TYPE_CUBE";break;case ea:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Bm(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case ji:e="ENVMAP_MODE_REFRACTION";break}return e}function zm(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Qr:e="ENVMAP_BLENDING_MULTIPLY";break;case Ah:e="ENVMAP_BLENDING_MIX";break;case Rh:e="ENVMAP_BLENDING_ADD";break}return e}function km(i){let e=i.envMapCubeUVHeight;if(e===null)return null;let t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function Hm(i,e,t,n){let s=i.getContext(),r=t.defines,o=t.vertexShader,a=t.fragmentShader,l=Om(t),c=Fm(t),h=Bm(t),d=zm(t),f=km(t),m=t.isWebGL2?"":Am(t),x=Rm(t),v=Cm(r),p=s.createProgram(),u,P,S=t.glslVersion?"#version "+t.glslVersion+`
...
`,g),null}let ps=Tt.getAttribute("version");console.debug("THREE.ColladaLoader: File version",ps);let Gs=h(n(Tt,"asset")[0]),ms=new Zr(this.manager);ms.setPath(this.resourcePath||t).setCrossOrigin(this.crossOrigin);let da;Bs&&(da=new Bs(this.manager),da.setPath(this.resourcePath||t));let Ws=new Ke,Xs=[],Bo={},eh=0,qe={animations:{},clips:{},controllers:{},images:{},effects:{},materials:{},cameras:{},lights:{},geometries:{},nodes:{},visualScenes:{},kinematicsModels:{},physicsModels:{},kinematicsScenes:{}};m(Tt,"library_animations","animation",p),m(Tt,"library_animation_clips","animation_clip",O),m(Tt,"library_controllers","controller",X),m(Tt,"library_images","image",ie),m(Tt,"library_effects","effect",Ue),m(Tt,"library_materials","material",Le),m(Tt,"library_cameras","camera",tt),m(Tt,"library_lights","light",Se),m(Tt,"library_geometries","geometry",he),m(Tt,"library_nodes","node",Xe),m(Tt,"library_visual_scenes","visual_scene",us),m(Tt,"library_kinematics_models","kinematics_model",ut),m(Tt,"library_physics_models","physics_model",Vs),m(Tt,"scene","instance_kinematics_scene",ua),x(qe.animations,S),x(qe.clips,Q),x(qe.controllers,z),x(qe.images,re),x(qe.effects,oe),x(qe.materials,Te),x(qe.cameras,Ye),x(qe.lights,Ie),x(qe.geometries,rt),x(qe.visualScenes,vt),fs(),J();let qs=ci(n(Tt,"scene")[0]);return qs.animations=Xs,Gs.upAxis==="Z_UP"&&(console.warn("THREE.ColladaLoader: You are loading an asset with a Z-UP coordinate system. The loader just rotates the asset to transform it into Y-UP. The vertex data are not converted, see #24289."),qs.rotation.set(-Math.PI/2,0,0)),qs.scale.multiplyScalar(Gs.unit),{get animations(){return console.warn("THREE.ColladaLoader: Please access animations over scene.animations now."),Xs},kinematics:Bo,library:qe,scene:qs}}};var Kl=document.getElementById("stage"),Gn=new Ps({canvas:Kl,antialias:!0});Gn.setPixelRatio(Math.min(window.devicePixelRatio,2));Gn.setSize(window.innerWidth,window.innerHeight,!1);Gn.shadowMap.enabled=!0;Gn.shadowMap.type=Ro;Gn.toneMapping=Co;Gn.toneMappingExposure=1.25;Gn.outputColorSpace=Et;var wn=new is,zs={cobalt:["#2563EB","#93C5FD","#1E3A5F"],neko:["#35BFAB","#EDDD62","#166056"],graphite:["#4F46E5","#818CF8","#312E81"],citrus:["#EA580C","#FDBA74","#9A3412"],teal:["#0D9488","#5EEAD4","#134E4A"],damson:["#BE185D","#F472B6","#500724"],lavender:["#7C3AED","#C4B5FD","#3B0764"],terracotta:["#B84A2D","#F3D1BE","#7C2D12"]};function Ei(i,e,t){let n=parseInt(i.slice(1),16),s=parseInt(e.slice(1),16),r=(c,h)=>Math.round(c+(h-c)*t),o=r(n>>16&255,s>>16&255),a=r(n>>8&255,s>>8&255),l=r(n&255,s&255);return"#"+(1<<24|o<<16|a<<8|l).toString(16).slice(1)}function wg(i,e,t){let n=document.createElement("canvas");n.width=2,n.height=512;let s=n.getContext("2d"),r=s.createLinearGradient(0,0,0,512);r.addColorStop(0,i),r.addColorStop(.55,e),r.addColorStop(.8,Ei(t,"#ffffff",.45)),r.addColorStop(1,t),s.fillStyle=r,s.fillRect(0,0,2,512);let o=new Hr(n);return o.colorSpace=Et,o}var oi=new Lt(35,window.innerWidth/window.innerHeight,.1,800),En=new ra(oi,Kl);En.enableDamping=!0;En.dampingFactor=.08;En.autoRotate=!0;En.autoRotateSpeed=1.1;En.maxPolarAngle=Math.PI*.52;En.minDistance=2;var Fo=new Jr(16774888,12109528,.9);wn.add(Fo);var zt=new si(16773853,2.4);zt.castShadow=!0;zt.shadow.mapSize.set(4096,4096);zt.shadow.bias=-25e-5;zt.shadow.normalBias=.02;zt.shadow.radius=8;zt.shadow.blurSamples=24;zt.shadow.camera.near=.5;zt.shadow.camera.far=80;wn.add(zt);var $l=new si(14477567,.55);wn.add($l);var jl=new si(16777215,.5);wn.add(jl);var oa=new os(9684477,0,30);wn.add(oa);var ks=new Kt(new Cs(1,1),new Vr({opacity:.16}));ks.rotation.x=-Math.PI/2;ks.receiveShadow=!0;wn.add(ks);function Zl(i){if(!i||i.isMeshStandardMaterial||i.isMeshBasicMaterial)return i;let e={color:i.color?i.color.clone():new Ke(16777215),roughness:.86,metalness:0,side:i.side??hn};(i.transparent||i.opacity<1)&&(e.transparent=!0,e.opacity=i.opacity??1),i.emissive&&i.emissive.getHex()!==0&&(e.emissive=i.emissive.clone(),e.emissiveIntensity=i.emissiveIntensity??1);let t=new Gr(e);return t.name=i.name??"residence-material",t}function Tg(i){i.traverse(e=>{e.isMesh&&(Array.isArray(e.material)?e.material=e.material.map(Zl):e.material=Zl(e.material),e.castShadow=!0,e.receiveShadow=!0,e.geometry&&e.geometry.computeVertexNormals())})}function Jl(i){let e=zs[i]||zs.cobalt;wn.background=wg(Ei(e[1],"#7fd4f2",.38),Ei(e[1],"#ffffff",.72),Ei(e[1],"#ffe6c0",.72)),Fo.color.set(Ei(e[1],"#ffffff",.35)),Fo.groundColor.set(Ei(e[2],"#ffffff",.6)),oa.color.set(Ei(e[1],"#ffffff",.35)),oa.intensity=1.1}var Ag=new aa;Ag.load("residence-smith.dae",i=>{let e=i.scene;Tg(e);let t=new Mn().setFromObject(e),n=t.getCenter(new U),s=t.getSize(new U),r=Math.max(s.x,s.y,s.z)||8,o=Math.max(s.x,s.z)||6;e.position.x-=n.x,e.position.z-=n.z,e.position.y-=t.min.y,wn.add(e),ks.position.y=0,ks.scale.set(o*3,o*3,1),En.target.set(0,s.y*.45,0);let a=r*1.7;oi.position.set(a*.55,a*.62,a),oi.near=Math.max(.05,r/200),oi.far=r*8,oi.updateProjectionMatrix(),En.maxDistance=a*3,En.update(),zt.position.set(-r*.55,r*.95,r*.6),zt.target.position.set(0,s.y*.3,0),wn.add(zt.target),zt.shadow.camera.left=-o*1.1,zt.shadow.camera.right=o*1.1,zt.shadow.camera.top=o*1.1,zt.shadow.camera.bottom=-o*1.1,zt.shadow.camera.far=r*4,zt.shadow.camera.updateProjectionMatrix(),$l.position.set(r*.5,r*.4,r*.4),jl.position.set(0,r*.5,-r*.8),oa.position.set(0,r*.7,0);let l=(location.hash||"").replace("#","");try{let c=parent.document.documentElement.getAttribute("data-theme");c&&zs[c]&&(l=c)}catch{}Jl(zs[l]?l:"cobalt"),window.addEventListener("message",c=>{let h=c&&c.data;h&&h.type==="le-theme"&&zs[h.theme]&&Jl(h.theme)})});window.addEventListener("resize",()=>{oi.aspect=window.innerWidth/window.innerHeight,oi.updateProjectionMatrix(),Gn.setSize(window.innerWidth,window.innerHeight,!1)});function Ql(){requestAnimationFrame(Ql),En.update(),Gn.render(wn,oi)}Ql();})();
